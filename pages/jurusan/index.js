...
import { fetchAllJurusan, setPage } from "../../redux/jurusan/actions";
import Swal from "sweetalert2";
import { destroy } from "../../services/jurusan";
                  ...
                  <tr key={index}>
                    ...
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center space-x-1">
                      <button
                        ...
                        onClick={() =>
                          router.push(`/jurusan/ubah/${value?._id}`)
                        }
                      >
                        Ubah
                      </button>
