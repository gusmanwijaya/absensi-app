...
import { fetchAllSiswa, setPage } from "../../redux/siswa/actions";
import Swal from "sweetalert2";
import { destroy } from "../../services/siswa";
                  ...
                  <tr key={index}>
                    ...
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center space-x-1">
                      <button
                        ...
                        onClick={() =>
                          router.push(`/siswa/detail/${value?._id}`)
                        }
                      >
                        Detail
                      </button>
                      <button
                        ...
                        onClick={() => router.push(`/siswa/ubah/${value?._id}`)}
                      >
                        Ubah
                      </button>
                      <button
